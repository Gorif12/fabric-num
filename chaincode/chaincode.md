...
#3. 核心业务方法
 ...
 #3.1 创建房产（仅限不动产机构）
  ```bash
     func (s *SmartContract) CreateRealEstate(ctx contractapi.TransactionContextInterface, id, address string, area float64, owner 
      string, createTime time.Time) error {
       // 权限校验
